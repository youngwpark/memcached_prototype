...
public class SoftwareEngineer extends Job implements Serializable
{
	
	private EnumSet<TechnologyEnum> requiredSkills = EnumSet.of(TechnologyEnum.JAVA,
																TechnologyEnum.UNIX, 
																TechnologyEnum.ECLIPSE);
	
	public SoftwareEngineer(final String title, 
